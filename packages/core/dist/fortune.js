 ...
 * @returns 起始年龄
 */
export function getStartingAge(bureau) {
    return bureau;
}
/**
 * 判断是否为阳（用于决定大限方向）
 ...
 */
export function isYangDirection(sex, yearStem) {
 ...
 */
export function calculateDecades(lifePalaceBranch, bureau, sex, yearStem, palaceBranches) {
    const result = {};
 ...
 * @returns 该年的地支
 */
export function getYearBranch(year) {
 ...
 * @returns 该年份对应的宫位名称
 */
export function getAnnualPalace(currentYear, palaceBranches) {
    // 获取该年份的地支
 ...
 */
export function formatDecadeRange(decade, birthYear) {
 ...
 */
export function getCurrentDecadePalace(age, decades) {
